...
def train():
    ...
    for epo in range(1, EPOCHS):
        for data in train_loader:
            ...
            loss_writer.add("mse loss", mse_loss.item(), iteration)
            ...
            if iteration % IMG_SAVE_FREQ == 0:
                predict_clear = torch.clamp(predict_clear, min=0, max=1)
